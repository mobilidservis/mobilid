<template>
    <div class=" fixed top-0 z-50 px-8 md:px-16 w-full h-28 flex justify-between items-center" :class="scroll<50 || `bg-white transition delay-150 duration-300 ease-in-out`" id="navbar" >
        ...
        <button class=" border-2 rounded-lg px-4 py-2 font-semibold font-epilogue" :class="scroll<50 ? `text-white  border-white`: `text-main-red border-main-red transition delay-150 duration-300 ease-in-out`">Hubungi Kami</button>
        </div>
    </div>
</template>
