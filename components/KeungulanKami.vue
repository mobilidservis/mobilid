    ...
    <div class="flex flex-col md:flex-row space-x-6 items-center">
      <div class="basis-1/2">
        ...
        <h1 class="text-[32px] text-white my-4 font-bold">
          Kenapa Anda Harus Memilih Kami Untuk Merawat Mobil Anda?
        </h1>
      </div>
      <div class="basis-1/2">
    ...
    <div class="flex flex-col md:flex-row space-x-6 items-center">
      ...
      <div class="basis-1/2">
        <div class="md:w-[580px] w-full aspect-square relative">
            ...
            <div
              class="-z-10 md:w-[580px] w-full top-3 left-3 aspect-square rounded-md overflow-hidden bg-main-gold absolute"
            ></div>
          </div>
      </div>
    </div>
...
const iconHero = [
  {
    ...
    image: "/image/mechanic.svg",
    content:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt",
  },
  {
    title: "Service di Depan Mata Anda",
    image: "/image/body-repair.svg",
    content:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt",
  },
  {
    title: "Teknologi Tercanggih",
    image: "/image/wrench.svg",
    content:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt",
  },
  {
    title: "Garansi",
    image: "/image/guarantee.svg",
    content:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt",
  },
];
